...
// index.ts
var sensehat_adapter_exports = {};
__export(sensehat_adapter_exports, {
  getSensorData: () => getSensorData,
  main: () => main
});
module.exports = __toCommonJS(sensehat_adapter_exports);
...
// types.ts
var weatherParamEnum = /* @__PURE__ */ ((weatherParamEnum2) => {
  weatherParamEnum2["PRESSURE"] = "pressure";
  weatherParamEnum2["HUMIDITY"] = "humidity";
  weatherParamEnum2["TEMPERATURE"] = "temperature";
  return weatherParamEnum2;
})(weatherParamEnum || {});

// index.ts
var getSensorData = async (inputData) => {
